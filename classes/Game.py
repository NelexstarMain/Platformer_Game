...
class Game:
    ...
    def __init__(self) -> None:
        self.screen: pygame.Surface = pygame.display.set_mode((set.screen_x, set.screen_y))
        self.clock: pygame.time.Clock = pygame.time.Clock()
        self.player: Player = Player(x=400, y=300)
        self.terrain: Terrain = Terrain()
        self.enemies: list = []
        self.spawners: list = [Spawner(x=random.randint(0, set.screen_x), y=random.randint(0, set.screen_y)) for _ in range(4)]
        self.bullets: list = []
